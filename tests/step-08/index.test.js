...
test('Parse SQL Query with INNER JOIN: Error Handling', async () => {
    const query = 'SELECT student.name, enrollment.course FROM student INNER JOIN enrollment student.id=enrollment.student_id';
    try {
...
test('Parse SQL Query with INNER JOIN and WHERE Clause: Error Handling', async () => {
    const query = 'SELECT student.name, enrollment.course FROM student INNER JOIN enrollment ON student.id = enrollment.student_id WHERE student.age > 20';
    try {
        await parseQuery(query);
        fail('Expected promise to reject');
...
test('Execute SQL Query with INNER JOIN: Error Handling', async () => {
    const query = 'SELECT student.name, enrollment.course FROM student INNER JOIN enrollment ON student.id=enrollment.student_id';
    try {
        await parseQuery(query);
        fail('Expected promise to reject');
...
test('Execute SQL Query with INNER JOIN and a WHERE Clause: Error Handling', async () => {
    const query = 'SELECT student.name, enrollment.course FROM student INNER JOIN enrollment ON student.id=enrollment.student_id';
    try {
        await parseQuery(query);
        fail('Expected promise to reject');
